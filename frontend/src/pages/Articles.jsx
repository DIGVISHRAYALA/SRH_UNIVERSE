...
const Articles = () => {
  ...
  return (
    <div className="articles">
      ...
      {/* SINGLE-ARTICLE SKELETON (shows only while loading) */}
      {isLoading && (
        <div className="article-box skeleton" aria-hidden>
          ...
          <div className="article-actions skeleton-actions">
            <div className="action-pair">
          ...
          <p className="meta">
            <span className="skeleton-meta-line" />
          </p>
          <hr className="divider" />
        </div>
      )}
